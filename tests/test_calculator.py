...
_SCENARIOS = [
    pytest.param(
        ...
        #   A: price=10_00 x2 → line 20_00; Fixed(A,3_00)→6_00, Pct10%→2_00    → net 14_00
        #   B: price=15_00 x1 → line 15_00; Pct40%(B)→6_00,     Pct10%→1_50   → net  9_00
        #   C: price= 8_00 x3 → line 24_00; Volume(C,7_00,min3)→7_00, Pct10%→2_40 → net 17_00
        #   total = 40_00
        [
    ...
    pytest.param(
        ...
        #   A: price=50_00 x1 → line 50_00; Fixed→5_00,  Pct25%→12_50 → net 37_50
        #   B: price=30_00 x2 → line 60_00; Fixed→10_00, Pct25%→15_00 → net 45_00
        #   total = 82_50
        [
    ...
    pytest.param(
        ...
        #   X: price=10_00 x5 → line 50_00; Volume(min3)→15_00, Fixed→10_00 → net 35_00
        #   Y: price=10_00 x2 → line 20_00; Volume not applicable,  Fixed→4_00  → net 16_00
        #   total = 51_00
        [
    ...
    pytest.param(
        ...
        #   A: price=20_00 x1 → line 20_00; Fixed(A)→12_00, Pct50%→10_00 → net  8_00
        #   B: price=20_00 x1 → line 20_00; Fixed(A) N/A,   Pct50%→10_00 → net 10_00
        #   total = 18_00
        [
    ...
    pytest.param(
        ...
        #   A: price=10_00 x1 → 10_00 (Fixed targets Z; Volume qty<5)
        #   B: price=10_00 x1 → 10_00 (same)
        #   total = 20_00
        [
